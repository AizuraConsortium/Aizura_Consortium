export const TOKENOMICS = {
  ...
  TREASURY_GUARDRAILS: {
    WEEKLY_CAPS: {
      STABLECOIN_AMOUNT_USD: 50_000,
      STABLECOIN_PERCENTAGE: 3,
      AAIC_AMOUNT: 250_000,
      AAIC_PERCENTAGE: 2,
    },
    BUYBACK: {
      MIN_FREQUENCY_HOURS: 168,
      SLIPPAGE_CAP_DEFAULT: 2.5,
      SLIPPAGE_CAP_MAX: 5,
      DAILY_SPEND_CAP_PERCENTAGE: 0.5,
    },
    LP_WITHDRAWAL: {
      MAX_PERCENTAGE_PER_MONTH: 25,
    },
